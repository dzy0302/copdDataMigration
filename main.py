    ...
    if table_mzf_check is None:
        try:
            ...
            cur.execute(
                ...
                'fcjc, mnfcjcys, fcjcfhcs, fcjcfhcs_kz, fcjcfhcs_fdmj, fcjcfhcs_fhf, fcjcfhcs_fctk, '
        ...
        try:
            logging.info('mzf表刷新')
            cur.execute(
                'UPDATE record_mzf2 SET gwys_xy = %s, gwys_hymxtdjb = %s, gwys_jzzkqwryzdq = %s, gwys_csjcfcgz = %s, '
                'gwys_ffhxhxdgr = %s, copdzd = %s, ywzl = %s, ywzl_dyxrzqgkzjsaba = %s, ywzl_dyxrzqgkzjsama = %s, '
                'ywzl_dyxrzqgkzjlaba = %s, ywzl_dyxrzqgkzjlama = %s, ywzl_dyxrzqgkzjsfgl = %s, ywzl_xrjssfgl = %s, '
                'ywzl_lhxrzjicslaba = %s, ywzl_lhxrzjicslabalama = %s, ywzl_lhxrzjlabalama = %s, ywzl_lhxrzjsfgl = %s, '
                ...
                'snzfqncxsj = %s, snzfqnsyqj = %s, zfqnfhcs = %s, zfqnfhcs_kz = %s, zfqnfhcs_fdmj = %s, '
                'zfqnfhcs_yyj = %s, zfqnfhcs_pqs = %s, zfqnfhpc = %s, qtfszf = %s, qtfszf_trq = %s, qtfszf_mb = %s, '
                'qtfszf_yhq = %s, mnsnzfyw = %s, snzfcxsj = %s, snzfsyqj = %s, snzffhcs = %s, snzffhcs_kz = %s, '
                'snzffhcs_fdmj = %s, snzffhcs_yyj = %s, snzffhcs_pqs = %s, snzffhcsqt = %s, snzffhpc = %s, fcjc = %s, '
                'mnfcjcys = %s, fcjcfhcs = %s, fcjcfhcs_kz = %s, fcjcfhcs_fdmj = %s, fcjcfhcs_fhf = %s, '
                'fcjcfhcs_fctk = %s, fcjcfhcs_qxz = %s, fcjcfhpc = %s, ydqtjc = %s, mnydqtjcys = %s, ydqtjccxsj = %s, '
                'ydqtjcfhcs = %s, ydqtjcfhcs_kz = %s, ydqtjcfhcs_fdmj = %s, ydqtjcfhcs_fhf = %s, ydqtjcfhcs_fctk = %s, '
                ...
                'ktjccxsj = %s, ktfffzsj = %s, cxzz = %s, cxywfzpl = %s, cxfzpl = %s, cxyfys_gm = %s, cxyfys_ll = %s, '
                'cxyfys_lkq = %s, cxyfys_tw = %s, cxyfys_ys = %s, cxyfys_jh = %s, cxyfys_gmy = %s, cxyfys_jl = %s, '
                'cxyfys_hjys = %s, cxjjx = %s, cxfffzsj = %s, fl = %s, zhdhlx = %s, yxsr = %s, em = %s, xm = %s, '
                'qd = %s, hr = %s, xp = %s, xp_lfwlzc = %s, xp_ljxzk = %s, fbct = %s, fbct_mxzqgy = %s, fbct_fqz = %s, '
                'fbct_fdp = %s, szqfev1fvc = %s, szqfev1yjz = %s, szqmmef = %s, szhfev1fvc = %s, szhfev1yjz = %s, '
                'szhmmef = %s, hqflspef = %s, mxzsxfjb = %s, qlsxjb = %s, qlsxzb = %s, kss = %s, xrzqgkzyw = %s, '
                'kfzqgkzyw = %s, xrjs = %s, qsjs = %s, qty = %s, mlst = %s, zyzl = %s, hxknpf = %s, ydnl6mwt = %s, '
                'hxjbpf = %s, kcnyht = %s, shzlpf = %s, sx_pd = %s, sx_sx = %s, sx_jz = %s, sx_wx = %s, sx_ch = %s, '
                'ss_d = %s, ss_h = %s, ss_z = %s, ss_a = %s, ss_ybyd = %s, sst_lh = %s, sst_jy = %s, sst_l = %s, '
                'sst_lan = %s, ts_bai = %s, ts_hu = %s, ts_he = %s, tz_bo = %s, tz_h = %s, tz_n = %s, tz_ba = %s, '
                'stgzcd = %s, stl = %s, stwz = %s, sxml = %s, CREATE_TIME = %s, UPDATE_TIME = %s;',
                (
                     common.get('gwys_xy') if common.get('gwys_xy') != '' else None,
                     common.get('gwys_hymxtdjb') if common.get('gwys_hymxtdjb') != '' else None,
                     common.get('gwys_jzzkqwryzdq') if common.get('gwys_jzzkqwryzdq') != '' else None,
                     ...
                     common.get('stwz') if common.get('stwz') != '' else None,
                     common.get('sxml') if common.get('sxml') != '' else None,
                     common.get('CREATE_TIME'), common.get('UPDATE_TIME')))
            conn.commit()
            return table_mzf_id
        except Exception as ex:
