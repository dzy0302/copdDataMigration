        ...
        if str(mzf_update_time) != str(common.get('UPDATE_TIME')):
            try:
                ...
                cur.execute(
                    ...
                    'hxdjbjzs = %s, ynnhxdgr = %s, ynnhxdgrcs = %s, zg = %s, psyg = %s, ynpjgmcs = %s, bbzz_ht = %s, '
                    'bbzz_qt = %s, bbzz_bs = %s, bbzz_hxbm = %s, ks = %s, kscd = %s, kssx = %s, ksjzys = %s, '
                    'ksjzys_gm = %s, ksjzys_tyhxxtyw = %s, ksjzys_ll = %s, ksjzys_lkq = %s, ksjzys_yd = %s, '
                    'ksjzys_ys = %s, ksjzys_jh = %s, ksjzys_gmy = %s, ksjzys_jl = %s, ksjzys_hjys = %s, kslxx = %s, '
                    'ksjjx = %s, ksjjx_c = %s, ksjjx_x = %s, ksjjx_q = %s, ksjjx_d = %s, ksjjx_jjzh = %s, '
                    'ksjccxsj = %s, ksfffzsj = %s, kt = %s, tzz = %s, tl = %s, ts_h = %s, ts_b = %s, ts_hbxj = %s, '
                    'ts_tzdx = %s, ktjccxsj = %s, ktfffzsj = %s, cxzz = %s, cxywfzpl = %s, cxfzpl = %s, '
                    'cxyfys_gm = %s, cxyfys_ll = %s, cxyfys_lkq = %s, cxyfys_tw = %s, cxyfys_ys = %s, cxyfys_jh = %s, '
                    'cxyfys_gmy = %s, cxyfys_jl = %s, cxyfys_hjys = %s, cxjjx = %s, cxfffzsj = %s, fl = %s, '
                    'zhdhlx = %s, yxsr = %s, em = %s, xm = %s, qd = %s, hr = %s, xp = %s, xp_lfwlzc = %s, '
                    'xp_ljxzk = %s, fbct = %s, fbct_mxzqgy = %s, fbct_fqz = %s, fbct_fdp = %s, szqfev1fvc = %s, '
                    'szqfev1yjz = %s, szqmmef = %s, szhfev1fvc = %s, szhfev1yjz = %s, szhmmef = %s, hqflspef = %s, '
                    'mxzsxfjb = %s, qlsxjb = %s, qlsxzb = %s, kss = %s, xrzqgkzyw = %s, kfzqgkzyw = %s, xrjs = %s, '
                    'qsjs = %s, qty = %s, mlst = %s, zyzl = %s, hxknpf = %s, ydnl6mwt = %s, hxjbpf = %s, kcnyht = %s, '
                    'shzlpf = %s, sx_pd = %s, sx_sx = %s, sx_jz = %s, sx_wx = %s, sx_ch = %s, ss_d = %s, ss_h = %s, '
                    'ss_z = %s, ss_a = %s, ss_ybyd = %s, sst_lh = %s, sst_jy = %s, sst_l = %s, sst_lan = %s, '
                    'ts_bai = %s, ts_hu = %s, ts_he = %s, tz_bo = %s, tz_h = %s, tz_n = %s, tz_ba = %s, stgzcd = %s, '
                    'stl = %s, stwz = %s, sxml = %s, CREATE_TIME = %s, UPDATE_TIME = %s WHERE ID = %s;',
                    (
                         common.get('gwys_xy') if common.get('gwys_xy') != '' else None,
                         common.get('gwys_hymxtdjb') if common.get('gwys_hymxtdjb') != '' else None,
                         common.get('gwys_jzzkqwryzdq') if common.get('gwys_jzzkqwryzdq') != '' else None,
